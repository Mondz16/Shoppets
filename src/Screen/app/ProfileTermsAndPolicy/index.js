...
const ProfileTermsAndPolicy = ({navigation}) => {
  ...
  async function getFirebaseData() {
    await firestore()
      ...
      .doc('AppInfo')
      .onSnapshot(x => {
        var existingData = JSON.parse(x.data().terms);
      ...
      <ScrollView>
        ...
        <LinearGradient
          ...
          <View style={styles.profileButtonHeader}>
              <Text style={styles.modalText}>Welcome to Shoppets! Before you begin using our application, please take a moment to read through our Terms and Conditions.</Text>
            </View>
          <FlatList
          data={userData}
          numColumns={1}
...
export default React.memo(ProfileTermsAndPolicy);
